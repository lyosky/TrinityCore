...
enum TypeID
{
    ...
    TYPEID_ITEM                 = 1,
    TYPEID_CONTAINER            = 2,
    TYPEID_AZERITEEMPOWEREDITEM = 3,
    TYPEID_AZERITEITEM          = 4,
    TYPEID_UNIT               = 5,
    TYPEID_PLAYER             = 6,
    TYPEID_ACTIVEPLAYER       = 7,
    TYPEID_GAMEOBJECT         = 8,
...
#define NUM_CLIENT_OBJECT_TYPES             17
...
enum TypeMask
{
    ...
    TYPEMASK_AZERITEPOWEREDITEM = 0x0008,
    TYPEMASK_AZERITEITEM        = 0x0010,
    TYPEMASK_UNIT           = 0x0020,
    TYPEMASK_PLAYER         = 0x0040,
    TYPEMASK_ACTIVEPLAYER   = 0x0080,
