...
{
    CONTAINER_DYNAMIC_END = ITEM_DYNAMIC_END + 0x00,
};
...
enum UnitFields
{
    ...
    UNIT_FIELD_DISPLAYSCALE                                 = OBJECT_END + 0x066, // Size: 1, Flags: DYNAMIC, URGENT
    UNIT_FIELD_NATIVEDISPLAYID                              = OBJECT_END + 0x067, // Size: 1, Flags: PUBLIC, URGENT
    UNIT_FIELD_NATIVEXDISPLAYSCALE                          = OBJECT_END + 0x068, // Size: 1, Flags: PUBLIC, URGENT
    ...
    UNIT_FIELD_MAIN_HAND_ATTACK_POWER                       = OBJECT_END + 0x0A2, // Size: 1, Flags: PRIVATE, OWNER
    UNIT_FIELD_OFF_HAND_ATTACK_POWER                        = OBJECT_END + 0x0A3, // Size: 1, Flags: PRIVATE, OWNER
    UNIT_FIELD_RANGED_WEAPON_ATTACK_POWER                   = OBJECT_END + 0x0A4, // Size: 1, Flags: PRIVATE, OWNER
...
enum PlayerFields
{
    ...
    PLAYER_FIELD_END_NOT_SELF                                       = UNIT_END + 0x688,

    PLAYER_FIELD_INV_SLOT_HEAD                        = PLAYER_FIELD_END_NOT_SELF + 0x000, // Size: 780, Flags: PUBLIC
    PLAYER_FARSIGHT                                   = PLAYER_FIELD_END_NOT_SELF + 0x30C, // Size: 4, Flags: PUBLIC
    PLAYER_FIELD_SUMMONED_BATTLE_PET_ID               = PLAYER_FIELD_END_NOT_SELF + 0x310, // Size: 4, Flags: PUBLIC
    PLAYER_FIELD_KNOWN_TITLES                         = PLAYER_FIELD_END_NOT_SELF + 0x314, // Size: 12, Flags: PUBLIC
    PLAYER_FIELD_COINAGE                              = PLAYER_FIELD_END_NOT_SELF + 0x320, // Size: 2, Flags: PUBLIC
    PLAYER_XP                                         = PLAYER_FIELD_END_NOT_SELF + 0x322, // Size: 1, Flags: PUBLIC
    PLAYER_NEXT_LEVEL_XP                              = PLAYER_FIELD_END_NOT_SELF + 0x323, // Size: 1, Flags: PUBLIC
    PLAYER_TRIAL_XP                                   = PLAYER_FIELD_END_NOT_SELF + 0x324, // Size: 1, Flags: PUBLIC
    PLAYER_SKILL_LINEID                               = PLAYER_FIELD_END_NOT_SELF + 0x325, // Size: 896, Flags: PUBLIC
    PLAYER_CHARACTER_POINTS                           = PLAYER_FIELD_END_NOT_SELF + 0x6A5, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MAX_TALENT_TIERS                     = PLAYER_FIELD_END_NOT_SELF + 0x6A6, // Size: 1, Flags: PUBLIC
    PLAYER_TRACK_CREATURES                            = PLAYER_FIELD_END_NOT_SELF + 0x6A7, // Size: 1, Flags: PUBLIC
    PLAYER_TRACK_RESOURCES                            = PLAYER_FIELD_END_NOT_SELF + 0x6A8, // Size: 2, Flags: PUBLIC
    PLAYER_EXPERTISE                                  = PLAYER_FIELD_END_NOT_SELF + 0x6AA, // Size: 1, Flags: PUBLIC
    PLAYER_OFFHAND_EXPERTISE                          = PLAYER_FIELD_END_NOT_SELF + 0x6AB, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_RANGED_EXPERTISE                     = PLAYER_FIELD_END_NOT_SELF + 0x6AC, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_COMBAT_RATING_EXPERTISE              = PLAYER_FIELD_END_NOT_SELF + 0x6AD, // Size: 1, Flags: PUBLIC
    PLAYER_BLOCK_PERCENTAGE                           = PLAYER_FIELD_END_NOT_SELF + 0x6AE, // Size: 1, Flags: PUBLIC
    PLAYER_DODGE_PERCENTAGE                           = PLAYER_FIELD_END_NOT_SELF + 0x6AF, // Size: 1, Flags: PUBLIC
    PLAYER_DODGE_PERCENTAGE_FROM_ATTRIBUTE            = PLAYER_FIELD_END_NOT_SELF + 0x6B0, // Size: 1, Flags: PUBLIC
    PLAYER_PARRY_PERCENTAGE                           = PLAYER_FIELD_END_NOT_SELF + 0x6B1, // Size: 1, Flags: PUBLIC
    PLAYER_PARRY_PERCENTAGE_FROM_ATTRIBUTE            = PLAYER_FIELD_END_NOT_SELF + 0x6B2, // Size: 1, Flags: PUBLIC
    PLAYER_CRIT_PERCENTAGE                            = PLAYER_FIELD_END_NOT_SELF + 0x6B3, // Size: 1, Flags: PUBLIC
    PLAYER_RANGED_CRIT_PERCENTAGE                     = PLAYER_FIELD_END_NOT_SELF + 0x6B4, // Size: 1, Flags: PUBLIC
    PLAYER_OFFHAND_CRIT_PERCENTAGE                    = PLAYER_FIELD_END_NOT_SELF + 0x6B5, // Size: 1, Flags: PUBLIC
    PLAYER_SPELL_CRIT_PERCENTAGE1                     = PLAYER_FIELD_END_NOT_SELF + 0x6B6, // Size: 1, Flags: PUBLIC
    PLAYER_SHIELD_BLOCK                               = PLAYER_FIELD_END_NOT_SELF + 0x6B7, // Size: 1, Flags: PUBLIC
    PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE               = PLAYER_FIELD_END_NOT_SELF + 0x6B8, // Size: 1, Flags: PUBLIC
    PLAYER_MASTERY                                    = PLAYER_FIELD_END_NOT_SELF + 0x6B9, // Size: 1, Flags: PUBLIC
    PLAYER_SPEED                                      = PLAYER_FIELD_END_NOT_SELF + 0x6BA, // Size: 1, Flags: PUBLIC
    PLAYER_AVOIDANCE                                  = PLAYER_FIELD_END_NOT_SELF + 0x6BB, // Size: 1, Flags: PUBLIC
    PLAYER_STURDINESS                                 = PLAYER_FIELD_END_NOT_SELF + 0x6BC, // Size: 1, Flags: PUBLIC
    PLAYER_VERSATILITY                                = PLAYER_FIELD_END_NOT_SELF + 0x6BD, // Size: 1, Flags: PUBLIC
    PLAYER_VERSATILITY_BONUS                          = PLAYER_FIELD_END_NOT_SELF + 0x6BE, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_PVP_POWER_DAMAGE                     = PLAYER_FIELD_END_NOT_SELF + 0x6BF, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_PVP_POWER_HEALING                    = PLAYER_FIELD_END_NOT_SELF + 0x6C0, // Size: 1, Flags: PUBLIC
    PLAYER_EXPLORED_ZONES_1                           = PLAYER_FIELD_END_NOT_SELF + 0x6C1, // Size: 320, Flags: PUBLIC
    PLAYER_FIELD_REST_INFO                            = PLAYER_FIELD_END_NOT_SELF + 0x801, // Size: 4, Flags: PUBLIC
    PLAYER_FIELD_MOD_DAMAGE_DONE_POS                  = PLAYER_FIELD_END_NOT_SELF + 0x805, // Size: 7, Flags: PUBLIC
    PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                  = PLAYER_FIELD_END_NOT_SELF + 0x80C, // Size: 7, Flags: PUBLIC
    PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                  = PLAYER_FIELD_END_NOT_SELF + 0x813, // Size: 7, Flags: PUBLIC
    PLAYER_FIELD_MOD_HEALING_DONE_POS                 = PLAYER_FIELD_END_NOT_SELF + 0x81A, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_HEALING_PCT                      = PLAYER_FIELD_END_NOT_SELF + 0x81B, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_HEALING_DONE_PCT                 = PLAYER_FIELD_END_NOT_SELF + 0x81C, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT    = PLAYER_FIELD_END_NOT_SELF + 0x81D, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS               = PLAYER_FIELD_END_NOT_SELF + 0x81E, // Size: 3, Flags: PUBLIC
    PLAYER_FIELD_WEAPON_ATK_SPEED_MULTIPLIERS         = PLAYER_FIELD_END_NOT_SELF + 0x821, // Size: 3, Flags: PUBLIC
    PLAYER_FIELD_MOD_SPELL_POWER_PCT                  = PLAYER_FIELD_END_NOT_SELF + 0x824, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_RESILIENCE_PERCENT               = PLAYER_FIELD_END_NOT_SELF + 0x825, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_AP_PCT       = PLAYER_FIELD_END_NOT_SELF + 0x826, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_OVERRIDE_AP_BY_SPELL_POWER_PERCENT   = PLAYER_FIELD_END_NOT_SELF + 0x827, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_TARGET_RESISTANCE                = PLAYER_FIELD_END_NOT_SELF + 0x828, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE       = PLAYER_FIELD_END_NOT_SELF + 0x829, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_LOCAL_FLAGS                          = PLAYER_FIELD_END_NOT_SELF + 0x82A, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_BYTES                                = PLAYER_FIELD_END_NOT_SELF + 0x82B, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_PVP_MEDALS                           = PLAYER_FIELD_END_NOT_SELF + 0x82C, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_BUYBACK_PRICE_1                      = PLAYER_FIELD_END_NOT_SELF + 0x82D, // Size: 12, Flags: PUBLIC
    PLAYER_FIELD_BUYBACK_TIMESTAMP_1                  = PLAYER_FIELD_END_NOT_SELF + 0x839, // Size: 12, Flags: PUBLIC
    PLAYER_FIELD_KILLS                                = PLAYER_FIELD_END_NOT_SELF + 0x845, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_LIFETIME_HONORABLE_KILLS             = PLAYER_FIELD_END_NOT_SELF + 0x846, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_WATCHED_FACTION_INDEX                = PLAYER_FIELD_END_NOT_SELF + 0x847, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_COMBAT_RATING_1                      = PLAYER_FIELD_END_NOT_SELF + 0x848, // Size: 32, Flags: PUBLIC
    PLAYER_FIELD_ARENA_TEAM_INFO_1_1                  = PLAYER_FIELD_END_NOT_SELF + 0x868, // Size: 54, Flags: PUBLIC
    PLAYER_FIELD_MAX_LEVEL                            = PLAYER_FIELD_END_NOT_SELF + 0x89E, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_SCALING_PLAYER_LEVEL_DELTA           = PLAYER_FIELD_END_NOT_SELF + 0x89F, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MAX_CREATURE_SCALING_LEVEL           = PLAYER_FIELD_END_NOT_SELF + 0x8A0, // Size: 1, Flags: PUBLIC
    PLAYER_NO_REAGENT_COST_1                          = PLAYER_FIELD_END_NOT_SELF + 0x8A1, // Size: 4, Flags: PUBLIC
    PLAYER_PET_SPELL_POWER                            = PLAYER_FIELD_END_NOT_SELF + 0x8A5, // Size: 1, Flags: PUBLIC
    PLAYER_PROFESSION_SKILL_LINE_1                    = PLAYER_FIELD_END_NOT_SELF + 0x8A6, // Size: 2, Flags: PUBLIC
    PLAYER_FIELD_UI_HIT_MODIFIER                      = PLAYER_FIELD_END_NOT_SELF + 0x8A8, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_UI_SPELL_HIT_MODIFIER                = PLAYER_FIELD_END_NOT_SELF + 0x8A9, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_HOME_REALM_TIME_OFFSET               = PLAYER_FIELD_END_NOT_SELF + 0x8AA, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_MOD_PET_HASTE                        = PLAYER_FIELD_END_NOT_SELF + 0x8AB, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_BYTES2                               = PLAYER_FIELD_END_NOT_SELF + 0x8AC, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_BYTES3                               = PLAYER_FIELD_END_NOT_SELF + 0x8AD, // Size: 1, Flags: PUBLIC, URGENT_SELF_ONLY
    PLAYER_FIELD_LFG_BONUS_FACTION_ID                 = PLAYER_FIELD_END_NOT_SELF + 0x8AE, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_LOOT_SPEC_ID                         = PLAYER_FIELD_END_NOT_SELF + 0x8AF, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_OVERRIDE_ZONE_PVP_TYPE               = PLAYER_FIELD_END_NOT_SELF + 0x8B0, // Size: 1, Flags: PUBLIC, URGENT_SELF_ONLY
    PLAYER_FIELD_BAG_SLOT_FLAGS                       = PLAYER_FIELD_END_NOT_SELF + 0x8B1, // Size: 4, Flags: PUBLIC
    PLAYER_FIELD_BANK_BAG_SLOT_FLAGS                  = PLAYER_FIELD_END_NOT_SELF + 0x8B5, // Size: 7, Flags: PUBLIC
    PLAYER_FIELD_INSERT_ITEMS_LEFT_TO_RIGHT           = PLAYER_FIELD_END_NOT_SELF + 0x8BC, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_QUEST_COMPLETED                      = PLAYER_FIELD_END_NOT_SELF + 0x8BD, // Size: 1750, Flags: PUBLIC
    PLAYER_FIELD_HONOR                                = PLAYER_FIELD_END_NOT_SELF + 0xF93, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_HONOR_NEXT_LEVEL                     = PLAYER_FIELD_END_NOT_SELF + 0xF94, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_PVP_TIER_MAX                         = PLAYER_FIELD_END_NOT_SELF + 0xF95, // Size: 1, Flags: PUBLIC
    PLAYER_FIELD_PVP_LAST_WEEKS_TIER_MAX              = PLAYER_FIELD_END_NOT_SELF + 0xF96, // Size: 1, Flags: PUBLIC
    PLAYER_END                                        = PLAYER_FIELD_END_NOT_SELF + 0xF97,
};

enum PlayerDynamicFields
{
    PLAYER_DYNAMIC_FIELD_ARENA_COOLDOWNS              = UNIT_DYNAMIC_END + 0x000, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_HEIRLOOMS                    = UNIT_DYNAMIC_END + 0x001, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_HEIRLOOM_FLAGS               = UNIT_DYNAMIC_END + 0x002, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_TOYS                         = UNIT_DYNAMIC_END + 0x003, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_TRANSMOG                     = UNIT_DYNAMIC_END + 0x004, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_CONDITIONAL_TRANSMOG         = UNIT_DYNAMIC_END + 0x005, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SELF_RES_SPELLS              = UNIT_DYNAMIC_END + 0x006, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_CHARACTER_RESTRICTIONS       = UNIT_DYNAMIC_END + 0x007, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SPELL_PCT_MOD_BY_LABEL       = UNIT_DYNAMIC_END + 0x008, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_SPELL_FLAT_MOD_BY_LABEL      = UNIT_DYNAMIC_END + 0x009, // Flags: PUBLIC
    PLAYER_DYNAMIC_FIELD_RESEARCH                     = UNIT_DYNAMIC_END + 0x00A, // Flags: PUBLIC
    PLAYER_DYNAMIC_END                                = UNIT_DYNAMIC_END + 0x00B,
};

enum GameObjectFields
{
    GAMEOBJECT_FIELD_CREATED_BY                             = OBJECT_END + 0x000, // Size: 4, Flags: PUBLIC
    GAMEOBJECT_GUILD                                        = OBJECT_END + 0x004, // Size: 4, Flags: PUBLIC
    ...
    GAMEOBJECT_CUSTOM_PARAM                                 = OBJECT_END + 0x019, // Size: 1, Flags: PUBLIC, URGENT
...
enum CorpseFields
{
    ...
    CORPSE_FIELD_GUILD                                      = OBJECT_END + 0x008, // Size: 4, Flags: PUBLIC
