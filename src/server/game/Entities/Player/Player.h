...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        */
        ...
        ObjectGuid::LowType GetGuildId() const { return GetUInt64Value(OBJECT_FIELD_ENTRY); /* return only lower part */ }
        Guild* GetGuild();
        ...
        uint32 GetPrestigeLevel() const { return GetUInt32Value(PLAYER_FIELD_HONOR_LEVEL); }
