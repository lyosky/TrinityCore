...
namespace Connection_Patcher
{
    namespace Patterns
    {
        struct Common
        {
            ...
            static std::vector<unsigned char> CertBundleUrl() { return { 'h', 't', 't', 'p', ':', '/', '/', 'n', 'y', 'd', 'u', 's', '.', 'b', 'a', 't', 't', 'l', 'e', '.', 'n', 'e', 't', '/', 'B', 'n', 'e', 't', '/', 'z', 'x', 'x', '/', 'c', 'l', 'i', 'e', 'n', 't', '/', 'b', 'g', 's', '-', 'k', 'e', 'y', '-', 'f', 'i', 'n', 'g', 'e', 'r', 'p', 'r', 'i', 'n', 't' }; }
            static std::vector<unsigned char> CertSignatureModulus() { return { 0x75, 0xE2, 0x21, 0xE5, 0xED, 0x10, 0xFD, 0xAD }; }
        };
    }
}
